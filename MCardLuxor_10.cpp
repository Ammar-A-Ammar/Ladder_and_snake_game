...
MCardLuxor_10::MCardLuxor_10(const CellPosition& pos) : Card(pos), city_price(0), fees(0), pcityowner(NULL)
// set the cell position of the card
{
	cardNumber = 10; // set the inherited cardNumber data member with the card number (1 here)
}
int MCardLuxor_10::Getprice()
{
	return city_price;
}
int MCardLuxor_10::Getfees()
{
	return fees;
}
MCardLuxor_10::~MCardLuxor_10(void)
{
}
Player* MCardLuxor_10::Getcityowner()
{
	return pcityowner;
}
void MCardLuxor_10::Setpcmortgaged(Player* x)
{
	pcmortgaged = x;
}
Player* MCardLuxor_10::Getpcmortgaged()
{
	return  pcmortgaged;

}
void MCardLuxor_10::Setcityowner(Player* owner)
{
	pcityowner = owner;
}
void MCardLuxor_10::ReadCardParameters(Grid* pGrid)
{
	...
	op->PrintMessage("New MONOPLY Card : Luxor.... click to cintinue");
...
void MCardLuxor_10::Apply(Grid* pGrid, Player* pPlayer)
{
