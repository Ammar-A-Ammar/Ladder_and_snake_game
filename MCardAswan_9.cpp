...
MCardAswan_9::MCardAswan_9(const CellPosition& pos) : Card(pos), city_price(0), fees(0), pcityowner(NULL)
// set the cell position of the card
{
	cardNumber = 9; // set the inherited cardNumber data member with the card number (1 here)
}
int MCardAswan_9::Getprice()
{
	return city_price;
}
int MCardAswan_9::Getfees()
{
	return fees;
}
void MCardAswan_9::Setpcmortgaged(Player* x)
{
	pcmortgaged = x;
}
Player* MCardAswan_9::Getpcmortgaged()
{
	return  pcmortgaged;

}
MCardAswan_9::~MCardAswan_9(void)
{
}
Player* MCardAswan_9::Getcityowner()
{
	return pcityowner;
}
void MCardAswan_9::Setcityowner(Player* owner)
{
	pcityowner = owner;
}
void MCardAswan_9::ReadCardParameters(Grid* pGrid)
{
	...
	op->PrintMessage("New MONOPLY Card : Aswan.... click to cintinue");
...
void MCardAswan_9::Apply(Grid* pGrid, Player* pPlayer)
{
