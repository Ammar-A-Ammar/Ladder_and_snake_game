...
MCardCairo_7::MCardCairo_7(const CellPosition& pos) : Card(pos), city_price(0), fees(0), pcityowner(NULL)
// set the cell position of the card
{
	cardNumber = 7; // set the inherited cardNumber data member with the card number (1 here)
}
int MCardCairo_7::Getprice()
{
	return city_price;
}
int MCardCairo_7::Getfees()
{
	return fees;
}
MCardCairo_7::~MCardCairo_7(void)
{
}
Player* MCardCairo_7::Getcityowner()
{
	return pcityowner;
}
void MCardCairo_7::Setpcmortgaged(Player* x)
{
	pcmortgaged = x;
}
Player* MCardCairo_7::Getpcmortgaged()
{
	return  pcmortgaged;

}
void MCardCairo_7::Setcityowner(Player* owner)
{
	pcityowner = owner;
}
void MCardCairo_7::ReadCardParameters(Grid* pGrid)
{
	...
	op->PrintMessage("New MONOPLY Card : Cairo.... click to cintinue");
...
void MCardCairo_7::Apply(Grid* pGrid, Player* pPlayer)
{
