...
public:
	...
	void DeleteGameObject(const CellPosition& pos);
	...
	void Saving(ofstream&, ObjType, string);
	...
	Snake* GetNextSnake(const CellPosition& position); // gets a pointer to the first snake
	Coinset* GetNextCoinSet(const CellPosition& position); // gets a pointer to the first coinset
	Card* GetNextCard(const CellPosition& position); // gets a pointer to the first card
